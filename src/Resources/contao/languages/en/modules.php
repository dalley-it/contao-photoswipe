...
$GLOBALS['TL_LANG']['MOD']['dait_photoswipe'][1] = 'Manage Galleries'; /*[1]Mouse-Hover-String*/

$GLOBALS['TL_LANG']['FMD']['dait_photoswipe'] = 'Photoswipe Gallery'; /*Name of the module in Backend (Type of Module)*/
