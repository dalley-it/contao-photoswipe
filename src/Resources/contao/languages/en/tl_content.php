...
$GLOBALS['TL_LANG']['tl_content']['photoswipe_gallery'][0] = 'Photoswipe Gallery';
$GLOBALS['TL_LANG']['tl_content']['photoswipe_gallery'][1] = 'Choose your photoswipe gallery to use its settings.';
$GLOBALS['TL_LANG']['tl_content']['photoswipe_legend'] = 'Photoswipe gallery-selection';
